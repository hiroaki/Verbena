...
ActiveRecord::Schema[8.1].define(version: 2026_02_03_061101) do
  ...
  create_table "mail_queues", force: :cascade do |t|
    ...
    t.index ["delivery_status"], name: "index_mail_queues_on_delivery_status"
    t.index ["eml_source_id"], name: "index_mail_queues_on_eml_source_id"
    t.index ["timer_at"], name: "index_mail_queues_on_timer_at"
    t.index ["token_id"], name: "index_mail_queues_on_token_id"
  end
  ...
  add_foreign_key "mail_queues", "tokens", on_delete: :restrict
